...
public class ImperialWithUI extends GUIState
{
	...
	private CategoryDataset createDataset( String label )
	{
		...
		String name0 = ( new K(2, 2) ).getName();
	...
	private XYDataset createSeriesDataset()
	{
		...
		E0 = new TimeSeries(( new K(2, 2) ).getName());
	...
	public ImperialWithUI()
	{
		super(new Imperial(System.currentTimeMillis()));
	}

	public ImperialWithUI( SimState state )
	{
		super(state);
	}
		...
		Steppable timeSeriesUpdater = new Steppable()
		{
			...
			public void step( SimState state )
			{
				...
				for ( int i = 0; i < risk.territories.numObjs; i++ )
				{
					...
					{
						case 1:
							size0 += territory.getConquered().numObjs;
							break;
						case 2:
							size1 += territory.getConquered().numObjs;
							break;
						case 3:
							size2 += territory.getConquered().numObjs;
							break;
						case 4:
							size3 += territory.getConquered().numObjs;
							break;
						case 5:
							size4 += territory.getConquered().numObjs;
							break;
						case 6:
							size5 += territory.getConquered().numObjs;
							break;
						case 7:
							size6 += territory.getConquered().numObjs;
							break;
					}
				}
				E0.add(period, size0);
	...
	public void init( Controller c )
	{
		...
		territoriesChart = ChartFactory.createBarChart("", "Empire's Name", "Territories under direct control", territoriesBars, PlotOrientation.VERTICAL, false, false, false);
		...
		influenceChart = ChartFactory.createBarChart("", "Empire's Name", "Kingdoms under influence", influenceBars, PlotOrientation.VERTICAL, false, false, false);
		...
		peopleChart = ChartFactory.createBarChart("", "Empire's Name", "Wealth", wealthBars, PlotOrientation.VERTICAL, false, false, false);
